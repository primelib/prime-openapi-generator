...
import io.github.primelib.primecodegen.core.generator.AbstractCleanJavaCodegen;
import io.github.primelib.primecodegen.core.util.GeneratorUtils;
import io.github.primelib.primecodegen.javafeign.config.JavaFeignGeneratorConfig;
import io.github.primelib.primecodegen.javafeign.utils.JavaCodegenUtils;
...
public class JavaFeignGenerator extends AbstractCleanJavaCodegen implements CodegenConfig, INitroCodegen {
    ...
    public void processOpts() {
        ...
        // supporting files
        cfg.addNitroFile(NitroCodegenFile.builder().sourceTemplate("gitignore.peb").targetDirectory(outputFolder).targetFileName(".gitignore").scope(NitroScope.SUPPORT).build());
